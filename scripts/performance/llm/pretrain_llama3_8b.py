...
if __name__ == "__main__":
    ...
    num_nodes, mbs, gbs, tp_size, pp_size, cp_size, vp_size, ep_size, _, enable_cuda_graphs, use_mcore_fsdp = kwargs[:11]

    recipe = override_recipe_configs(
        args, num_nodes, mbs, gbs, tp_size, pp_size, cp_size, vp_size, ep_size, enable_cuda_graphs, use_mcore_fsdp
    )

    exp_config = f"{num_nodes}nodes_tp{tp_size}_pp{pp_size}_cp{cp_size}_vp{vp_size}_mbs{mbs}_gbs{gbs}_recomp{args.recompute_layers}_fsdp{use_mcore_fsdp}_ubr{args.use_user_buffer_registration}_sharp{args.use_sharp}"
